...
Esto es lo que habia dentro del panel.

![https://imgur.com/4aYPwTI.png](https://imgur.com/4aYPwTI.png)

Para ganar `RCE` tenia que crearme una `webshell` en PHP y subirla al servidor, tras acceder dentro de la carpeta `Users` y `michelle` encontre un panel de subida de archivos.

![https://imgur.com/5Ymu1KI.png](https://imgur.com/5Ymu1KI.png)
